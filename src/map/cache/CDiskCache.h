...
public:
    ...
    virtual void store(const QString& key, QImage& img) override;
    virtual void restore(const QString& key, QImage& img) override;
    virtual bool contains(const QString& key) override;
