    ...
    : QWidget(parent)
{
    ...
    const QString msg = tr(
        ...
        "enthusiast and volunteers. It's fun but lacks certain amenities you might be used from 'free' "
        "commercial software. As a matter of fact we lack the resources to provide you with a centralized and "
        ...
        "There is a <a href='quick'>Quick Start Guide</a> translated into several languages. Read it and you will "
        ...
        "</ul>"
        "<p>Do you want to create these folders now? Give me a <a  href='CreateHome'>path</a>.</p>"
        "</td>"
        "</tr>"
        "<tr>"
        "<td>"
        ...
        "Wiki where we try to collect information about all kind of available sources. </p>"
        "</td>"
        "</tr>"
        "</table>"
        );
