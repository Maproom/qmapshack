...
CDemPropSetup::CDemPropSetup(IDem* demfile, CDemDraw* dem) : IDemProp(demfile, dem) {
  setupUi(this);
  ...
  connect(spinBoxElevationLimit, QOverload<int>::of(&QSpinBox::valueChanged), this,
          &CDemPropSetup::slotElevationValueChanged);
  ...
  connect(spinBoxElevationShadeLimitLow, QOverload<int>::of(&QSpinBox::valueChanged), this,
          &CDemPropSetup::slotElevationShadeLowValueChanged);
  connect(spinBoxElevationShadeLimitHi, QOverload<int>::of(&QSpinBox::valueChanged), this,
          &CDemPropSetup::slotElevationShadeHiValueChanged);
  ...
  connect(comboGrades, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this,
          &CDemPropSetup::slotGradeIndex);
