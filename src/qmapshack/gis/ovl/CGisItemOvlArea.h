...
class CGisItemOvlArea : public IGisItem, public IGisLine {
 ...
 public:
  ...
  const QString& getName() const override { return area.name.isEmpty() ? noName : area.name; }
  ...
  const QString& getComment() const override { return area.cmt; }
  const QString& getDescription() const override { return area.desc; }
  const QList<link_t>& getLinks() const override { return area.links; }
  ...
  const width_t lineWidths[OVL_N_WIDTHS] = {{3, tr("thin")}, {5, tr("normal")}, {9, tr("wide")}, {13, tr("strong")}};

  const Qt::BrushStyle brushStyles[OVL_N_STYLES] = {Qt::NoBrush,          Qt::HorPattern,   Qt::VerPattern,
                                                    Qt::CrossPattern,     Qt::BDiagPattern, Qt::FDiagPattern,
                                                    Qt::DiagCrossPattern, Qt::SolidPattern};
