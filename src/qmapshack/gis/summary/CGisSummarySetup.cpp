...
CGisSummarySetup::CGisSummarySetup(CGisSummary& parent) : QDialog(&parent), summary(parent) {
  setupUi(this);
  ...
  labelHelp->setText(
      tr("<b>What is this about?</b><br/>"
         ...
         "summary projects into the workspace, copying the items and saving the changes. Or "
...
void CGisSummarySetup::setupSignals(CGisSummary::dropzone_e number, QLineEdit* lineName, QListWidget* listWidget,
                                    QToolButton* toolAdd, QToolButton* toolDel) {
  ...
  connect(listWidget, &QListWidget::itemSelectionChanged, this,
          [this, listWidget, toolDel]() { slotItemSelectionChanged(listWidget, toolDel); });
...
void CGisSummarySetup::writeResults(CGisSummary::dropzone_e number, QLineEdit* lineName,
