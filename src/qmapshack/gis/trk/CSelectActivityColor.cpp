...
CSelectActivityColor::CSelectActivityColor(QWidget* parent)
    : QWidget(parent), INotifyTrk(CGisItemTrk::eVisualColorAct) {
  setupUi(this);
}
...
void CSelectActivityColor::slotSetColor(QToolButton* button, trkact_t act) {
  ...
  if (trk != nullptr) {
    trk->updateVisuals(CGisItemTrk::eVisualDetails | CGisItemTrk::eVisualPlot | CGisItemTrk::eVisualProject |
                           CGisItemTrk::eVisualTrkInfo,
                       "CSelectActivityColor::slotSetColor()");
  }
}
