...
public:
    ...
    static QList<QString> getSearchTypeKeywords()
    {
...
private:
    ...
    static QMap<search_type_e,std::function<bool(searchValue_t, searchValue_t)> > searchTypeLambdaMap;
    static QMap<search_type_e,std::function<bool(searchValue_t, searchValue_t)> > initSearchTypeLambdaMap();
};
