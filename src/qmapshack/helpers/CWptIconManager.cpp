...
void CWptIconManager::init() {
  ...
  wptIcons["Oval, Red"] = icon_t("://icons/waypoints/32x32/OvalRed.png", 16, 16);
  wptIcons["Oval, Blue"] = icon_t("://icons/waypoints/32x32/OvalBlue.png", 16, 16);
  wptIcons["Oval, Green"] = icon_t("://icons/waypoints/32x32/OvalGreen.png", 16, 16);
  wptIcons["Rectangle, Red"] = icon_t("://icons/waypoints/32x32/RectangleRed.png", 16, 16);
  wptIcons["Rectangle, Blue"] = icon_t("://icons/waypoints/32x32/RectangleBlue.png", 16, 16);
  wptIcons["Rectangle, Green"] = icon_t("://icons/waypoints/32x32/RectangleGreen.png", 16, 16);
  ...
  wptIcons["Letter A, Red"] = icon_t("://icons/waypoints/32x32/LetterARed.png", 16, 16);
  wptIcons["Letter A, Blue"] = icon_t("://icons/waypoints/32x32/LetterABlue.png", 16, 16);
  wptIcons["Letter A, Green"] = icon_t("://icons/waypoints/32x32/LetterAGreen.png", 16, 16);
  wptIcons["Letter B, Red"] = icon_t("://icons/waypoints/32x32/LetterBRed.png", 16, 16);
  wptIcons["Letter B, Blue"] = icon_t("://icons/waypoints/32x32/LetterBBlue.png", 16, 16);
  wptIcons["Letter B, Green"] = icon_t("://icons/waypoints/32x32/LetterBGreen.png", 16, 16);
  wptIcons["Letter C, Red"] = icon_t("://icons/waypoints/32x32/LetterCRed.png", 16, 16);
  wptIcons["Letter C, Blue"] = icon_t("://icons/waypoints/32x32/LetterCBlue.png", 16, 16);
  wptIcons["Letter C, Green"] = icon_t("://icons/waypoints/32x32/LetterCGreen.png", 16, 16);
  wptIcons["Letter D, Red"] = icon_t("://icons/waypoints/32x32/LetterDRed.png", 16, 16);
  wptIcons["Letter D, Blue"] = icon_t("://icons/waypoints/32x32/LetterDBlue.png", 16, 16);
  wptIcons["Letter D, Green"] = icon_t("://icons/waypoints/32x32/LetterDGreen.png", 16, 16);
  wptIcons["Number 0, Red"] = icon_t("://icons/waypoints/32x32/Number0Red.png", 16, 16);
  wptIcons["Number 0, Blue"] = icon_t("://icons/waypoints/32x32/Number0Blue.png", 16, 16);
  wptIcons["Number 0, Green"] = icon_t("://icons/waypoints/32x32/Number0Green.png", 16, 16);
  wptIcons["Number 1, Red"] = icon_t("://icons/waypoints/32x32/Number1Red.png", 16, 16);
  wptIcons["Number 1, Blue"] = icon_t("://icons/waypoints/32x32/Number1Blue.png", 16, 16);
  wptIcons["Number 1, Green"] = icon_t("://icons/waypoints/32x32/Number1Green.png", 16, 16);
  wptIcons["Number 2, Red"] = icon_t("://icons/waypoints/32x32/Number2Red.png", 16, 16);
  wptIcons["Number 2, Blue"] = icon_t("://icons/waypoints/32x32/Number2Blue.png", 16, 16);
  wptIcons["Number 2, Green"] = icon_t("://icons/waypoints/32x32/Number2Green.png", 16, 16);
  wptIcons["Number 3, Red"] = icon_t("://icons/waypoints/32x32/Number3Red.png", 16, 16);
  wptIcons["Number 3, Blue"] = icon_t("://icons/waypoints/32x32/Number3Blue.png", 16, 16);
  wptIcons["Number 3, Green"] = icon_t("://icons/waypoints/32x32/Number3Green.png", 16, 16);
  wptIcons["Number 4, Red"] = icon_t("://icons/waypoints/32x32/Number4Red.png", 16, 16);
  wptIcons["Number 4, Blue"] = icon_t("://icons/waypoints/32x32/Number4Blue.png", 16, 16);
  wptIcons["Number 4, Green"] = icon_t("://icons/waypoints/32x32/Number4Green.png", 16, 16);
  wptIcons["Number 5, Red"] = icon_t("://icons/waypoints/32x32/Number5Red.png", 16, 16);
  wptIcons["Number 5, Blue"] = icon_t("://icons/waypoints/32x32/Number5Blue.png", 16, 16);
  wptIcons["Number 5, Green"] = icon_t("://icons/waypoints/32x32/Number5Green.png", 16, 16);
  wptIcons["Number 6, Red"] = icon_t("://icons/waypoints/32x32/Number6Red.png", 16, 16);
  wptIcons["Number 6, Blue"] = icon_t("://icons/waypoints/32x32/Number6Blue.png", 16, 16);
  wptIcons["Number 6, Green"] = icon_t("://icons/waypoints/32x32/Number6Green.png", 16, 16);
  wptIcons["Number 7, Red"] = icon_t("://icons/waypoints/32x32/Number7Red.png", 16, 16);
  wptIcons["Number 7, Blue"] = icon_t("://icons/waypoints/32x32/Number7Blue.png", 16, 16);
  wptIcons["Number 7, Green"] = icon_t("://icons/waypoints/32x32/Number7Green.png", 16, 16);
  wptIcons["Number 8, Red"] = icon_t("://icons/waypoints/32x32/Number8Red.png", 16, 16);
  wptIcons["Number 8, Blue"] = icon_t("://icons/waypoints/32x32/Number8Blue.png", 16, 16);
  wptIcons["Number 8, Green"] = icon_t("://icons/waypoints/32x32/Number8Green.png", 16, 16);
