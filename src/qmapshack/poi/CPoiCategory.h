...
{
public:
    CPoiCategory(const QString& categoryName, QVariant categoryID, Qt::CheckState checkedState, CPoiCategory *parent);
    CPoiCategory(const QString& categoryName, QVariant categoryID, QTreeWidget * parent);
