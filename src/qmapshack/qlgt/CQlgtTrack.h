...
class CFlags {
 public:
  ...
  virtual ~CFlags() {}
  quint32 flag() const { return flags; }
...
class CQlgtTrack : public QObject, public IItem {
 ...
 public:
  ...
  enum multi_color_item_e { eMultiColorNone, eMultiColorSlope, eMultiColorEle, eMultiColorSpeed, eMultiColorMax };
