...
void CGridPlacer::updateStatus()
{
    ...
    {
        labelStatusPoint1->setText(tr("<b style='color: green'>Point 1 - ok"));

        if((pt2 != NOPOINTF) && (pt2.x() < pt1.x()))
        {
            statusIsOk = false;
            labelStatusPoint1->setText(("<b style='color: red'>Point 1 - bad"));
        }
    ...
    {
        labelStatusPoint2->setText(tr("<b style='color: green'>Point 2 - ok"));

        if((pt1 != NOPOINTF) && (pt1.x() > pt2.x()))
        {
            statusIsOk = false;
            labelStatusPoint2->setText(("<b style='color: red'>Point 2 - bad"));
        }
    ...
    {
        labelStatusPoint3->setText(tr("<b style='color: green'>Point 3 - ok"));

        if((pt4 != NOPOINTF) && (pt4.x() > pt3.x()))
        {
            statusIsOk = false;
            labelStatusPoint3->setText(("<b style='color: red'>Point 3 - bad"));
        }
    ...
    {
        labelStatusPoint4->setText(tr("<b style='color: green'>Point 4 - ok"));

        if((pt3 != NOPOINTF) && (pt3.x() < pt4.x()))
        {
            statusIsOk = false;
            labelStatusPoint4->setText(("<b style='color: red'>Point 4 - bad"));
        }
